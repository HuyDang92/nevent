        ...
        <form onSubmit={formik.handleSubmit} className="mt-3">
          ...
          <div className="mt-5 grid w-full grid-cols-2 gap-2">
            ...
            <div className="relative pt-3">
              ...
              {categoryIpt !== '' && (
                <div className="absolute z-20 w-full rounded border-[1px] border-cs_light dark:bg-cs_lightDark bg-cs_light shadow-border-full p-3 dark:text-cs_light">
                  {categories.data
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                {categoryArr?.map((cate: ICategory, index: number) => (
                  <div
                    key={index}
                    className="text-cs_light font-semibold my-1 flex w-fit cursor-pointer items-center justify-between gap-1 rounded-lg bg-cs_semi_green p-1 pl-3 dark:text-cs_light"
                  >
                    <span>{cate.name}</span>
                    <Icon
                      name="close"
