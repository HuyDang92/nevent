    ...
    <div className={`w-full px-24 py-4 ${className}`}>
      <Stepper activeStep={activeStep} activeLineClassName="bg-cs_semi_green">
        <Step
          ...
          onClick={() => {
            navigate(`/organization/edit-event/${idEvent}/0`);
            // if (activeStep >= 1) {
            // }
          }}
        ...
        <Step
          ...
          onClick={() => {
            navigate(`/organization/edit-event/${idEvent}/1`);
            // if (activeStep >= 2) {
            // }
          }}
          activeClassName="!bg-cs_semi_green text-white"
        ...
        <Step
          // onClick={() => setActiveStep(activeStep >= 1 ? 1 : activeStep)}
          onClick={() => {
            navigate(`/organization/edit-event/${idEvent}/2`);
            // if (activeStep >= 3) {
            // }
          }}
          activeClassName="!bg-cs_semi_green text-white"
        ...
        {/* <Step
          // onClick={() => setActiveStep(activeStep >= 1 ? 1 : activeStep)}
          onClick={() => {
            navigate(`/organization/edit-event/${idEvent}/5`);
            // if (activeStep >= 4) {
            // }
          }}
          activeClassName="!bg-cs_semi_green text-white"
