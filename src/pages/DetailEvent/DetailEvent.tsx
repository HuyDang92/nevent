...
function DetailEvent() {
  ...
  const eventData = useGetEventByIdQuery(slug);

  if (!eventData.isFetching) {
    const detailEvent: IEvent = eventData.data.data;
                ...
                <div className=" leading-8">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      7, 21/10/2023 tại Trung tâm Hội nghị Adora Center, 431 Hoàng Văn Thụ, Phường 4, Quận Tân Bình,
                      TP.Hồ Chí Minh ▪️ Tên sự kiện: “LEE JONG SUK 2023 FANMEETING TOUR in HO CHI MINH”
                    </li>
                ...
                <div className="gap-4 sm:flex">
                  ...
                  <div className="w-3/4 pt-3 sm:pt-0">
                    ...
                    <p className="line-clamp-5">
                      ...
                      xây dựng; đầu tư, cho thuê bất động sản; xuất nhập khẩu các sản phẩm y tế;…Năm 2022, BÔM Hà Nội
                      phát triển lĩnh vực hoạt động nghệ thuật giải trí với tên gọi BOM Entertainment - mục đích là cầu
                      nối, kết nối, quảng bá văn hóa Hàn Quốc đến khán giả Việt Nam rộng rãi hơn nữa. BOM Entertainment
                      có mối quan hệ thân thiết với các công ty giải trí hàng đầu tại Hàn Quốc. Vào 21/10/2023 tại Trung
                      tâm Hội nghị Adora Center, 431 Hoàng Văn Thụ, Phường 4, Quận Tân Bình, TP.Hồ Chí Minh, BOM
                      Entertainment là đơn vị tổ chức chương trình Lee Jong Suk 2023 Fanmeeting tour – “Dear.My with”
                      trong Fanmeeting tour của diễn viên Lee Jong Suk.
                    </p>
                  </div>
                </div>
              </div>
