  ...
  return (
    <>
      ...
      <section className="min-h-screen rounded-xl bg-white p-8 dark:bg-cs_lightDark">
        <h1 className="text-2xl font-semibold dark:text-white">Thông tin ngân hàng</h1>
        <div className="mt-4 rounded-xl p-10 shadow-border-light">
          <div>
            <h1 className="text-xl font-semibold dark:text-white">Thông tin tài khoản ngân hàng của bạn</h1>
            <i className="text-sm text-gray-600">
              Nevent sẽ chuyển tiền thu được từ việc bán vé vào tài khoản ngân hàng của bạn
            </i>
          </div>
          <div className="my-5 rounded-lg border p-2 text-sm text-gray-600 dark:text-white">
