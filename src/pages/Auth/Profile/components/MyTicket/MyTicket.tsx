...
const MyTicket = ({ className }: UserInfoProp) => {
  const [statusMyTicket, setStatusMyTicket] = useState<StatusMyTicket>(StatusMyTicket.UNWORN);
  const getTickets = useGetMyTicketQuery(statusMyTicket);
      ...
      <Tabs>
        <TabsHeader className="mt-3 shadow-none sm:w-[40%]">
          <Tab
            ...
            index={0}
            onClick={() => setStatusMyTicket(StatusMyTicket.UNWORN)}
          >
